...
class _TypeCardState extends State<TypeCard> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant TypeCard oldWidget) {
...
class CardAnimation {
  static Animation<Alignment> frontCardAlign(
    ...
    } else if (_TypeCardState._trigger == -1) {
